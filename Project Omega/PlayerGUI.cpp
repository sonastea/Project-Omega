...
void PlayerGUI::initLevelBar()
{
	...
	this->levelBarText.setCharacterSize(gui::calcCharSize(this->vm, 200));
	this->levelBarText.setPosition(
		this->levelBarBack.getPosition().x + gui::p2pX(0.53f, this->vm),
		this->levelBarBack.getPosition().y + gui::p2pY(0.47f, this->vm)
	);
}
...
void PlayerGUI::initEXPBar()
{
	...
	float x = gui::p2pX(0.01f, this->vm);
...
void PlayerGUI::initHPBar()
{
	...
	float height = gui::p2pY(2.8f, this->vm);
	float x = gui::p2pX(0.10f, this->vm);
	...
	this->hpBarText.setPosition(
		this->hpBarInner.getPosition().x + gui::p2pX(0.52f, this->vm),
		this->hpBarInner.getPosition().y + gui::p2pY(0.47f, this->vm)
	);
}
